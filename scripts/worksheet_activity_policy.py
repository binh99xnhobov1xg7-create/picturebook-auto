...
L34_WORKSHEET_ACTIVITIES: dict[str, WorksheetActivity] = {
    ...
    "go_classification_map": WorksheetActivity(
        code="go_classification_map",
        page=7,
        module="Graphic Organizer",
        goal="Classify information from the book into clear groups.",
        student_instruction="Fill in the graphic organizer.",
        l3_support="Provide category labels, examples, and a word bank.",
        l4_support="Students complete category examples or short evidence phrases.",
        required_fields=("labels", "word_bank", "fillable_fields"),
        min_items=3,
        text_type="any",
        priority=12,
