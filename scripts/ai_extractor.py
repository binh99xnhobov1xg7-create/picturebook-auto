...
- 科普非虚构·封面/开篇(P1)：focus = "双主角小探索家正在观察/指认/探向本页科普对象的那一下"（如"Mia 蹲在岸边伸手指向跃出水面的小鱼"）。
- 科普非虚构·正文内页(P2-P7)：focus = "本页科普对象/知识过程的主体画面"（不出现 Mia/Tommy，纯知识可视化）。
...
- 科普非虚构·封面/开篇(P1)：hook 可以是"双主角小探索家发现的有趣现象"（如水面跃起的小鱼、岸边的小螃蟹）。
- 科普非虚构·正文内页(P2-P7)：hook 可以是科普对象本身的趣味细节（如跃起的小鱼、岸边的小螃蟹），不出现主角。
